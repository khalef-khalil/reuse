...
export default function WaterAnalyticsPage() {
  ...
  return (
    <div className="container-custom py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">Water Usage Analytics</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Detailed analysis of water consumption, conservation efforts, and sustainability metrics
        </p>
      </div>
              ...
              >
                <div className="flex justify-between">
                  ...
                  <div className="text-right">
                    <div className="font-medium text-green-600 dark:text-green-400">{initiative.savings} kGal</div>
                ...
                <div className="mt-2">
                  <div className="relative pt-1">
                    ...
                    <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-green-200 dark:bg-green-900/20">
                      <motion.div
                        initial={{ width: 0 }}
